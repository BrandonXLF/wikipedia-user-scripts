...
$(function(){
	...
	function merge (page) {
		if (pages[page].length > 1) {
			...
			var toggle = $('<span class="mw-collapsible-toggle mw-collapsible-arrow mw-enhancedchanges-arrow mw-enhancedchanges-arrow-space mw-collapsible-toggle-collapsed"></span>').click(function(){
			...
			var head = $('<li class="multi">').append(
				toggle,
