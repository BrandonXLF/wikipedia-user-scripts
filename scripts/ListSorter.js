...
(function(){
	...
	if (mw.config.get('wgPageName') == 'Wikipedia:User_scripts/List') {
		if (!$('#sortbulletlist-usl').length) mw.util.addPortletLink('p-cactions', mw.config.get('wgScript') + '?title=' + mw.config.get('wgPageName') + '&action=submit&sortbulletlists=true', 'Sort user scripts');
	}
})();